...
#SBATCH --output=/scratch/mg2745/A0_Discover_K80.out #this is the file for stdout 
#SBATCH --error=/scratch/mg2745/A0_Discover_K80.err #this is the file for stderr
