#!/bin/bash
#SBATCH --job-name=CS453_A0_Discover_A100  #the name of your job

#change to your NAU ID below
#SBATCH --output=/scratch/taj262/A0_Discover_A100.out #this is the file for stdout 
#SBATCH --error=/scratch/taj262/2/2/A0_Discover_A100.err #this is the file for stderr
