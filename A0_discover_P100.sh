...
#SBATCH --output=/scratch/taj262/A0_Discover_P100.out #this is the file for stdout 
#SBATCH --error=/scratch/taj262/A0_Discover_P100.err #this is the file for stderr
